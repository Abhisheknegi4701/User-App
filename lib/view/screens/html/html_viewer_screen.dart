...
class HtmlViewerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String? _data = htmlType == HtmlType.TERMS_AND_CONDITION
        ...
        ? Provider.of<SplashProvider>(context, listen: false).configModel!.aboutUs
        : htmlType == HtmlType.PRIVACY_POLICY
        ? Provider.of<SplashProvider>(context, listen: false).configModel!.privacyPolicy
        : htmlType == HtmlType.FAQ
        ? Provider.of<SplashProvider>(context, listen: false).configModel!.faq
        : null;
      ...
      appBar: ResponsiveHelper.isDesktop(context)
        ...
        title: getTranslated(
          htmlType == HtmlType.TERMS_AND_CONDITION
              ? 'terms_and_condition' : htmlType == HtmlType.ABOUT_US
              ? 'about_us' : htmlType == HtmlType.PRIVACY_POLICY
              ? 'privacy_policy' : htmlType == HtmlType.TERMS_AND_CONDITION
              ?  'terms_and_condition' : 'faq', context,
        )!,
      ),
