                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(children: [
                                  ...
                                  Builder(
                                    builder: (context) => Expanded(flex: 8, child: Row(children: [
                                      (order.trackModel!.paymentMethod!.length > 0) && order.trackModel!.paymentMethod == 'cash_on_delivery' ? Text(
                                        getTranslated('cash_on_delivery', context)!,style: poppinsRegular.copyWith(color: Theme.of(context).primaryColor),
                                      ) :
                                      Text(
                                        (order.trackModel!.paymentMethod!.length > 0)
                                ...
                                (order.trackModel!.orderNote!.isNotEmpty) ? Container(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if((order.trackModel!.orderStatus == 'processing' || order.trackModel!.orderStatus == 'out_for_delivery'))
                                  Center(
                                    child: Container(
                                      width:  double.infinity ,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text('(-) ${PriceConverter.convertPrice(context, _extraDiscount)}', style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                      ]),
                    ):SizedBox(),
